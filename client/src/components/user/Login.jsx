...
import { TextField, Button, Container, Typography, Box, CircularProgress,Grid,FormControlLabel,Checkbox } from '@mui/material';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (login_result.success) {
        // Use a timeout for redirect to allow toast to disappear
        setTimeout(() => {
          navigate('/'); // Navigate after successful login
        }, 2500); // Match the autoClose time or adjust as needed
      }
    } catch (error) {
